...
load("../data/database_2022-06-29.RData")
...
# sinN <- readxl::read_xlsx("../data/renataMilho28062022v2.xlsx", sheet="Sinonimos")
...
myHB <- "SXC1432ZL0" # sequiser o 6101ZL - nao precisa escrever o nome todo
