...
checksCS <- readxl::read_xlsx("../data/renataMilho28062022.xlsx", sheet="Checks")
checksCS$Esperado <- as.numeric(checksCS$Esperado)
sinN <- readxl::read_xlsx("../data/renataMilho28062022.xlsx", sheet="Sinonimos")
...
selBUs <- finalTabelaBU$Local[finalTabelaBU$classe %in% c("Media")]
...
nomeConjuntaGenotipos <- paste0("../output/conjunta_",myHB,"_CS_",Sys.Date(),".xlsx")
...
myCandidato$year <- as.numeric(myCandidato$year)
